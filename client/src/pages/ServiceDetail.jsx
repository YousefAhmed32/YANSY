    ...
    >
      ...
      >
        <span style={{
          ...
          fontWeight: 400,
          color: open ? '#d4af37' : 'rgba(255,255,255,0.88)',
          lineHeight: 1.4,
      ...
      <main className="bg-black text-white overflow-x-hidden" dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        >
          ...
          <div aria-hidden style={{
            ...
            background: 'radial-gradient(ellipse 70% 60% at 50% 0%, rgba(212,175,55,0.06) 0%, transparent 70%)',
          }} />
          {/* Gold line top */}
          <div aria-hidden style={{
          ...
          <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 w-full py-24">
            ...
            <nav data-hero-anim className="flex items-center gap-2 mb-8 opacity-0" aria-label="Breadcrumb">
              <Link to="/" style={{ fontSize: 11, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.35)', fontFamily: "'Inter', sans-serif" }}>Home</Link>
              <span style={{ color: 'rgba(255,255,255,0.2)' }}>›</span>
              <Link to="/services" style={{ fontSize: 11, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(255,255,255,0.35)', fontFamily: "'Inter', sans-serif" }}>Services</Link>
              <span style={{ color: 'rgba(255,255,255,0.2)' }}>›</span>
              <span style={{ fontSize: 11, letterSpacing: '0.2em', textTransform: 'uppercase', color: '#d4af37', fontFamily: "'Inter', sans-serif" }}>{service.title}</span>
            </nav>
            ...
            <div className="max-w-4xl">
              ...
              <h1 data-hero-anim className="opacity-0" style={{
                ...
                <br />
                <span style={{
                  backgroundImage: `linear-gradient(135deg, ${service.color} 0%, rgba(255,255,255,0.85) 55%)`,
              ...
              <div data-hero-anim className="flex flex-wrap gap-3 mb-12 opacity-0">
                <button
                  ...
                  style={{
                    ...
                    padding: '14px 36px', background: '#d4af37', border: '2px solid #d4af37',
                    color: '#000', fontFamily: "'Inter', sans-serif",
                    fontSize: 10, fontWeight: 500, letterSpacing: '0.22em', textTransform: 'uppercase',
                    cursor: 'pointer',
                    transition: 'background 0.3s, box-shadow 0.3s',
                  }}
                  onMouseEnter={e => { e.currentTarget.style.background = '#c4a030'; e.currentTarget.style.boxShadow = '0 8px 40px rgba(212,175,55,0.35)'; }}
                ...
                <a
                  ...
                  style={{
                    display: 'inline-flex', alignItems: 'center', gap: 10,
                    padding: '14px 28px', border: '2px solid rgba(255,255,255,0.15)',
              ...
              <div data-hero-anim className="grid grid-cols-2 sm:grid-cols-4 gap-0 opacity-0"
                style={{ borderTop: '1px solid rgba(255,255,255,0.07)', borderLeft: '1px solid rgba(255,255,255,0.07)', maxWidth: 560 }}>
                {service.hero.stats.map((s, i) => (
                  <div key={i} style={{
                    ...
                    <div style={{ fontFamily: "'Inter',system-ui,sans-serif", fontSize: 'clamp(1.4rem,3vw,2rem)', fontWeight: 400, color: '#d4af37', lineHeight: 1 }}>{s.num}</div>
                    <div style={{ fontFamily: "'Inter', sans-serif", fontSize: 10, fontWeight: 400, color: 'rgba(255,255,255,0.5)', marginTop: 4, letterSpacing: '0.08em' }}>{s.label}</div>
                  </div>
                ))}
              </div>
            </div>
        ...
        {/* ── PROBLEM ───────────────────────────────────────────── */}
        <section ref={sr(0)} style={{ padding: 'clamp(5rem,10vw,8rem) 0', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.95rem', fontWeight: 400, color: 'rgba(255,255,255,0.55)', lineHeight: 1.85, marginBottom: '2rem' }}>
                ...
                <ul className="space-y-3">
                  {service.problem.points.map((p, i) => (
                    <li key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                      <span style={{ width: 6, height: 6, borderRadius: '50%', background: 'rgba(212,175,55,0.5)', marginTop: 8, flexShrink: 0 }} aria-hidden />
                      <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.9rem', fontWeight: 400, color: 'rgba(255,255,255,0.6)', lineHeight: 1.7 }}>{p}</span>
                    </li>
                  ))}
                </ul>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              <div style={{ paddingTop: '3rem', order: 2 }}>
                <ul className="space-y-3">
                  {service.solution.points.map((p, i) => (
                    <li key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: 12 }}>
                      <CheckCircle2 size={16} style={{ color: '#d4af37', marginTop: 4, flexShrink: 0 }} aria-hidden />
                      <span style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.9rem', fontWeight: 400, color: 'rgba(255,255,255,0.7)', lineHeight: 1.7 }}>{p}</span>
                    </li>
                  ))}
                </ul>
              </div>
              <div style={{ order: 1 }}>
                ...
                <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.95rem', fontWeight: 400, color: 'rgba(255,255,255,0.55)', lineHeight: 1.85 }}>
          ...
          <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px" style={{ background: 'rgba(255,255,255,0.04)' }}>
              {service.process.map((step, i) => (
                ...
                >
                  <div style={{ fontFamily: "'Inter',system-ui,sans-serif", fontSize: 48, fontWeight: 400, color: 'rgba(212,175,55,0.12)', lineHeight: 1, marginBottom: 16 }}>
                    {String(step.step).padStart(2, '0')}
                  </div>
                  <h3 style={{ fontFamily: "'Inter',system-ui,sans-serif", fontSize: '1.2rem', fontWeight: 400, color: '#fff', marginBottom: 10, lineHeight: 1.3 }}>
                    {step.title}
                  </h3>
                  <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.875rem', fontWeight: 400, color: 'rgba(255,255,255,0.5)', lineHeight: 1.8 }}>
                    {step.desc}
                  </p>
                </div>
              ))}
        ...
        <section ref={sr(3)} style={{ padding: 'clamp(5rem,10vw,8rem) 0', background: 'linear-gradient(180deg, #000 0%, #060504 50%, #000 100%)' }}>
          <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
            <div className="text-center mb-16">
              ...
              <h2 style={{ fontFamily: "'Inter',system-ui,sans-serif", fontSize: 'clamp(2rem, 4vw, 3rem)', fontWeight: 400, color: '#fff', lineHeight: 1.1, letterSpacing: '-0.015em' }}>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {service.benefits.map((b, i) => (
                <div key={i} className="card-premium" style={{ padding: 'clamp(1.5rem,4vw,2rem)' }}>
                  ...
                  <h3 style={{ fontFamily: "'Inter',system-ui,sans-serif", fontSize: '1.1rem', fontWeight: 500, color: '#fff', marginBottom: 8 }}>{b.title}</h3>
                  <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.875rem', fontWeight: 400, color: 'rgba(255,255,255,0.5)', lineHeight: 1.75 }}>{b.desc}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        {/* ── TECH STACK ────────────────────────────────────────── */}
        <section ref={sr(4)} style={{ padding: 'clamp(3rem,6vw,5rem) 0', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        {/* ── RELATED SERVICES ──────────────────────────────────── */}
        <section ref={sr(6)} style={{ padding: 'clamp(4rem,8vw,6rem) 0', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
            <div className="mb-10">
              <span className="eyebrow" style={{ display: 'block', marginBottom: '0.75rem' }}>Also From YANSY TECH</span>
              <h2 style={{ fontFamily: "'Inter',system-ui,sans-serif", fontSize: 'clamp(1.5rem,3vw,2.2rem)', fontWeight: 400, color: '#fff', letterSpacing: '-0.01em' }}>
                Related Services
              </h2>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px" style={{ background: 'rgba(255,255,255,0.04)' }}>
              {SERVICES.filter(s => s.slug !== slug).slice(0, 3).map(s => (
                <Link
                  key={s.slug}
                  to={`/services/${s.slug}`}
                  style={{ background: '#000', padding: '2rem', display: 'block', transition: 'background 0.3s', textDecoration: 'none' }}
                  onMouseEnter={e => { e.currentTarget.style.background = '#070605'; }}
                  onMouseLeave={e => { e.currentTarget.style.background = '#000'; }}
                >
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                    <span style={{ fontSize: 11, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'rgba(212,175,55,0.6)', fontFamily: "'Inter', sans-serif" }}>{s.tagline}</span>
                    <ArrowUpRight size={14} style={{ color: 'rgba(255,255,255,0.3)' }} aria-hidden />
                  </div>
                  <h3 style={{ fontFamily: "'Inter',system-ui,sans-serif", fontSize: '1.3rem', fontWeight: 400, color: '#fff', lineHeight: 1.3 }}>{s.title}</h3>
                </Link>
              ))}
            </div>
          </div>
        ...
        <section ref={sr(7)} style={{
          ...
          <div className="max-w-2xl mx-auto px-5 sm:px-8">
            ...
            <h2 style={{ fontFamily: "'Inter',system-ui,sans-serif", fontSize: 'clamp(2rem, 5vw, 3.5rem)', fontWeight: 400, color: '#fff', lineHeight: 1.1, letterSpacing: '-0.02em', marginBottom: '1.5rem' }}>
              Let's Talk About Your {service.title} Project
            </h2>
            <p style={{ fontFamily: "'Inter', sans-serif", fontSize: '0.95rem', fontWeight: 400, color: 'rgba(255,255,255,0.5)', lineHeight: 1.85, marginBottom: '2.5rem' }}>
