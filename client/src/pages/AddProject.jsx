...
import { trackBookingRequest } from '../utils/ga4';
...
const AddProject = () => {
  ...
  const budgetOptions = [
    ...
    { value: '10000-plus', label: t('projectForm.budgetOptions.10000plus'), icon: '👑', color: 'from-[#B45309]/20 to-[#F59E0B]/5' }
  ];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      trackBookingRequest(formData.projectType || 'general');
      setIsSubmitted(true);
  ...
  if (isSubmitted) {
    return (
      ...
      >
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#B45309]/10 via-transparent to-[#B45309]/5 animate-gradient-shift" />
        ...
        <div className="text-center max-w-2xl relative z-10">
          <div className="mb-8">
            ...
            <div className="relative w-28 h-28 mx-auto mb-10">
              {/* Outer rings */}
              <div className="absolute inset-0 rounded-full bg-[#B45309]/20 animate-ping" />
              <div className="absolute inset-0 rounded-full bg-[#B45309]/10 animate-pulse" style={{ animationDelay: '0.5s' }} />
              
              {/* Main icon */}
              <div className="relative w-28 h-28 rounded-full bg-gradient-to-br from-[#B45309] via-[#F59E0B] to-[#B45309] flex items-center justify-center shadow-2xl shadow-[#B45309]/50 animate-scale-in">
              ...
              {[...Array(8)].map((_, i) => (
                ...
                >
                  <Sparkles className="w-4 h-4 text-[#B45309] animate-sparkle" style={{ animationDelay: `${i * 0.1}s` }} />
                </div>
              ))}
            </div>
  ...
  return (
    ...
    >
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute inset-0 bg-gradient-to-br from-[#B45309]/5 via-transparent to-[#B45309]/5 animate-gradient-slow" />
        <div 
        ...
        {[...Array(8)].map((_, i) => (
          <div
            key={i}
            className="absolute w-1 h-1 bg-[#B45309]/20 rounded-full animate-float-particles"
            style={{
              left: `${10 + i * 12}%`,
              top: `${5 + (i % 3) * 30}%`,
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <div className="text-center">
            ...
            <div className="mb-8 flex justify-center">
              <div className="relative">
                <div className="absolute inset-0 bg-[#B45309]/20 blur-2xl rounded-full animate-pulse" />
                <div className="relative w-20 h-20 rounded-2xl bg-gradient-to-br from-[#B45309] to-[#F59E0B] flex items-center justify-center shadow-xl shadow-[#B45309]/30 rotate-3 hover:rotate-0 transition-transform duration-500">
        ...
        <div className="mb-10">
          ...
          <div className="relative h-2 bg-white/5 rounded-full mb-8 overflow-hidden">
            <div 
              ref={progressBarRef}
              className="absolute inset-y-0 left-0 bg-gradient-to-r from-[#B45309] via-[#F59E0B] to-[#B45309] rounded-full transition-all duration-500 shadow-lg shadow-[#B45309]/50"
              ...
              <div key={step} className="flex-1 flex items-center">
                <div
                  ...
                  className={`relative group w-14 h-14 rounded-full flex items-center justify-center text-sm font-medium transition-all duration-500 ${
                    currentStep >= step
                      ? 'bg-gradient-to-br from-[#B45309] to-[#F59E0B] text-white scale-110 shadow-xl shadow-[#B45309]/50'
                ...
                >
                  ...
                  {currentStep === step && (
                    <>
                      <div className="absolute inset-0 rounded-full bg-[#B45309]/30 animate-ping" />
                      <div className="absolute inset-0 rounded-full bg-[#B45309]/20 animate-pulse" />
                    </>
                  )}

                  {/* Checkmark trail */}
                  {currentStep > step && (
                    <div className="absolute inset-0 rounded-full border-2 border-[#B45309] animate-expand-fade" />
                  )}
                </div>
                {step < 3 && (
        ...
        >
          ...
          <div className="absolute top-0 right-0 w-32 h-32 bg-[#B45309]/5 blur-3xl rounded-full" />
          <div className="absolute bottom-0 left-0 w-40 h-40 bg-[#B45309]/5 blur-3xl rounded-full" />
          ...
          <div className="absolute inset-0 pointer-events-none overflow-hidden">
            {[...Array(6)].map((_, i) => (
              <div
                key={i}
                className="absolute w-1.5 h-1.5 bg-[#B45309]/20 rounded-full animate-float-slow"
                style={{
                  left: `${15 + i * 15}%`,
                  top: `${10 + (i % 2) * 40}%`,
                    ...
                    {[
                      ...
                      <button
                        ...
                        className={`group relative p-8 border-2 rounded-2xl text-left transition-all duration-300 transform overflow-hidden ${
                          formData.clientType === option.type
                            ? 'border-[#B45309] bg-gradient-to-br from-[#B45309]/20 to-[#B45309]/5 scale-105 shadow-xl shadow-[#B45309]/20'
                      ...
                      >
                        ...
                        <div className={`absolute inset-0 bg-gradient-to-br ${
                          formData.clientType === option.type 
                            ? 'from-[#B45309]/10 to-transparent opacity-100' 
                            : 'from-white/5 to-transparent opacity-0 group-hover:opacity-100'
                        } transition-opacity duration-300`} />

                        {/* Selection indicator */}
                        {formData.clientType === option.type && (
                          <div className="absolute -top-3 -right-3 w-8 h-8 bg-[#B45309] rounded-full flex items-center justify-center shadow-lg animate-scale-in">
                ...
                <div>
                  ...
                  <div className="relative group">
                    <textarea
                      ...
                      rows={9}
                      className="w-full px-6 py-5 bg-white/5 border-2 border-white/10 rounded-2xl text-white placeholder-white/30 focus:outline-none focus:border-[#B45309] focus:bg-white/10 transition-all resize-none group-hover:border-white/20"
                    ...
                    {formData.projectDescription && (
                      <div className="absolute bottom-5 right-5 flex gap-1.5 bg-black/50 px-3 py-2 rounded-full backdrop-blur-sm">
                        <div className="w-2 h-2 bg-[#B45309] rounded-full animate-bounce" style={{ animationDelay: '0s' }} />
                        <div className="w-2 h-2 bg-[#B45309] rounded-full animate-bounce" style={{ animationDelay: '0.2s' }} />
                        <div className="w-2 h-2 bg-[#B45309] rounded-full animate-bounce" style={{ animationDelay: '0.4s' }} />
                      </div>
                    )}
                    {/* Focus glow */}
                    <div className="absolute inset-0 rounded-2xl bg-[#B45309]/5 opacity-0 group-focus-within:opacity-100 transition-opacity pointer-events-none" />
                  </div>
                    ...
                    {budgetOptions.map(option => (
                      <button
                        ...
                        className={`group relative px-7 py-5 border-2 rounded-xl text-left transition-all duration-300 transform overflow-hidden ${
                          formData.budgetRange === option.value
                            ? 'border-[#B45309] bg-gradient-to-r from-[#B45309]/20 to-[#B45309]/5 scale-102 shadow-lg shadow-[#B45309]/10'
                      ...
                      >
                        ...
                        <div className="relative flex items-center justify-between">
                          ...
                          {formData.budgetRange === option.value && (
                            <div className="w-6 h-6 bg-[#B45309] rounded-full flex items-center justify-center animate-scale-in">
            ...
            {currentStep === 3 && (
              <div className="space-y-7">
                ...
                <div className="relative p-6 bg-gradient-to-br from-white/10 to-white/5 border border-white/20 rounded-2xl overflow-hidden">
                  <div className="absolute top-0 right-0 w-32 h-32 bg-[#B45309]/10 blur-3xl" />
                  <div className="relative">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-6 py-4 bg-white/5 border-2 border-white/10 rounded-xl text-white placeholder-white/30 focus:outline-none focus:border-[#B45309] focus:bg-white/10 transition-all hover:border-white/20"
                  ...
                  <>
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full px-6 py-4 bg-white/5 border-2 border-white/10 rounded-xl text-white focus:outline-none focus:border-[#B45309] focus:bg-white/10 transition-all cursor-pointer hover:border-white/20"
                      >
            ...
            <div className="flex items-center justify-between mt-14 pt-8 border-t border-white/10">
              ...
              {currentStep < totalSteps ? (
                <button
                  type="button"
                  onClick={handleNext}
                  className="group relative overflow-hidden flex items-center gap-3 px-10 py-4 bg-gradient-to-r from-[#B45309] to-[#F59E0B] text-white text-sm font-medium tracking-widest uppercase transition-all rounded-xl shadow-lg shadow-[#B45309]/30 hover:shadow-xl hover:shadow-[#B45309]/50 hover:scale-105"
                >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="group relative overflow-hidden flex items-center gap-3 px-10 py-4 bg-gradient-to-r from-[#B45309] to-[#F59E0B] text-white text-sm font-medium tracking-widest uppercase transition-all rounded-xl shadow-lg shadow-[#B45309]/30 hover:shadow-xl hover:shadow-[#B45309]/50 hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
                >
                  {loading && (
