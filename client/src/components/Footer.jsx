...
const Footer = () => {
  ...
  const footerLinks = {
    services: [
      { label: isRTL ? 'مواقع تحوّل الزوار'  : 'Websites That Convert',     to: '/services/web-development' },
      { label: isRTL ? 'إطلاق منصة SaaS'      : 'Launch Your SaaS',          to: '/services/saas-development' },
      { label: isRTL ? 'متاجر تبيع 24/7'      : 'Stores That Sell 24/7',     to: '/services/ecommerce-development' },
      { label: isRTL ? 'تطبيقات موبايل'       : 'Mobile Apps',               to: '/services/mobile-app-development' },
      { label: isRTL ? 'أتمتة العمليات'       : 'Automate Operations',        to: '/services/enterprise-software' },
      { label: isRTL ? 'أنظمة الحجز الذكي'   : 'Smart Booking Systems',      to: '/services' },
    ],
    resources: [
    ...
    company: [
      ...
      { label: isRTL ? 'إستراتيجية المنتج' : 'Product Strategy',      to: '/services/product-strategy' },
      { label: isRTL ? 'الملف الشخصي'    : 'Client Portal',           to: '/login' },
    ],
  };
